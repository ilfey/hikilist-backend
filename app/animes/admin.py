...
class AdminAnime(admin.ModelAdmin):
    model = models.Anime
    list_display = ("id", "title", "episodes", "episodes_released", "format", "status", "announcement", "started", "released",)
    search_fields = ("id", "title", "episodes", "episodes_released", "announcement", "started", "released",)
    list_filter = ("episodes", "format", "episodes_released", "announcement", "started", "released",)
    list_editable = ("episodes", "episodes_released",)
    list_display_links = ("title",)
    save_on_top = True
